...
from .utils import SimpleNote, Part, Gnote, make_offset_set, as_fraction, FractionEncoder, pack_collate, pad_collate, round_number, read_txt
from .tokenizer import Tokenizer, JeongganTokenizer
...
class JeongganDataset:
  def __init__(self, data_path= Path('music_score/gencode'), 
    ...
    self.is_valid = is_valid
    self.score = self.get_score(part_list)
