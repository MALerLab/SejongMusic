...
from yeominrak_processing import AlignedScore, SamplingScore, pack_collate, ShiftedAlignedScore, TestScore, TestScoreCPH
...
save_name = 'CPH_from_1'
state = torch.load('outputs/2023-12-20/14-46-58/best_pitch_sim_model.pt')
state_alt = torch.load('outputs/2023-12-20/14-46-58/best_loss_model.pt')
...
model_alt = QkvAttnSeq2seq(model.tokenizer, config.model).to(device)
